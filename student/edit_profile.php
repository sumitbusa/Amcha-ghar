	...
	<div id="home_body" onclick="hide_signout();">
		...
		<div id="right_contents">
				<div id="right_middle_content">
					...
					<hr>
					<form method="post" name="updating_form" action="../process/student/updateprofile_process.php" onsubmit="return onformsubmit();">
						<div id="content" align="left">
							<table border="0">
								<tr >
									...
									<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
									<td>
										<input type="text" name="fname" id="fname" value="<?php echo $query_run_result['fname'];?>" onkeypress="return onlyAlphabets(event,this);" maxlength="20" required autofocus />
									</td>
									<td></td>
								</tr>
								<tr>
								...
								<tr>
									<td><lable class="edit_profile_lable">Roll no</lable></td>
									<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
									<td>
								...
								<tr>
									<td><lable class="edit_profile_lable">SAP no</lable></td>
									<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
									<td>
										<input type="text" name="sap_no" id="sap_no" value="<?php echo $query_info_run_result['sap_no'];?>"    onkeypress="return onlyNos(event,this);" onkeyup="sap_no_validate()" maxlength="11" required />
									</td>
									<td>
										<div style="float:right; width:300px; padding:6px 5px 6px 5px; font-size:17px; height:auto;" id="error_sapno"></div>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td><lable class="edit_profile_lable">Course</lable></td>
									<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
									<td>
										<select id="course" name="course" required />
											<option value="">Select..</option>
											<option value="IT" <?php if($query_info_run_result['course']=="IT"){echo "selected";} ?> >IT</option>
											<option value="CSE" <?php if($query_info_run_result['course']=="CSE"){echo "selected";} ?> >CSE</option>
										</select>
									</td>
									<td></td>
								</tr>
								<tr>
									<td><lable class="edit_profile_lable">Semester</lable></td>
									<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
									<td>
										<select id="semester" name="semester" required />
											<option value="">Select..</option>
											<option value="I" <?php if($query_info_run_result['semester']=="I"){echo "selected";} ?> >I</option>
											<option value="II" <?php if($query_info_run_result['semester']=="II"){echo "selected";} ?> >II</option>
											<option value="III" <?php if($query_info_run_result['semester']=="III"){echo "selected";} ?> >III</option>
											<option value="IV" <?php if($query_info_run_result['semester']=="VI"){echo "selected";} ?> >VI</option>
											<option value="V" <?php if($query_info_run_result['semester']=="V"){echo "selected";} ?> >V</option>
											<option value="VI" <?php if($query_info_run_result['semester']=="VI"){echo "selected";} ?> >VI</option>
										</select>
									</td>
									<td></td>
								</tr>
								<tr>
									...
									<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
									<td rowspan="2">
										<textarea name="address" id="address" value="" maxlength="150" required><?php echo$query_info_run_result['address'];?></textarea>
									</td>
									<td></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td rowspan="2" >
										<?php 
											if(isset($query_info_run_result['actual_pic']))
											{
										?>
												<img src="../images/Profile Pic/<?php echo $query_info_run_result['actual_pic']; ?>" height="50px" width="50px" />		
										<?php 
											}
											else
											{
