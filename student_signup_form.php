...
<html>
<header>
	<title>ToDoIst - Sign up account as a Student</title>
...
<div id="content_part">
	<div id="signup_content">
		...
		<div  style="width:800px; height:36px;">
			<div style="float:left;"><input type="password" id="sc_password" name="sc_password" size="36" tabindex="9" placeholder="Enter your confirm password here" maxlength="30" onkeyup="return passwordmatch()" onkeypress="return alphanumeric(event,this);" required /></div>
			<div style="float:right; width:400px; padding:6px 5px 6px 5px; font-size:17px; height:auto;" id="error_repassword"></div>
		</div>
		<div style="height:20px; width:382px; padding-top:16px;">Roll No</div>
		<div  style="width:800px; height:36px;">
			<div style="float:left;"><input type="text" id="college_id_no" name="college_id_no" size="36" tabindex="10" placeholder="Enter your College ID no" maxlength="7" required onkeypress="return onlyNos(event,this);" onkeyup="college_id_validate()" /></div>
		...
		<div style="width:382px; height:36px; float:left; border-radius:10px">
			...
			<div style="float:left;"><input type="reset" id="signup_btn" value="reset" tabindex="19" height="100%"/></div>
		</div>
		<input type="hidden" name="category" value="Student" required />
	</div>
</div>
</form>
