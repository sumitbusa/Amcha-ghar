...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../css/teacher/teacher_home_layout.css" />
	<link rel="stylesheet" type="text/css" href="../css/teacher/teacher_profile_layout.css" />
		...
		<div id="right_contents">
				<div id="right_middle_content">
					<?php
						...
						$query_info = "select * from teacher_info where college_id = '$college_id'";
					...
					<hr>
					<form method="post" name="updating_form" action="../process/teacher/updateprofile_process.php" onsubmit="return onformsubmit();">
