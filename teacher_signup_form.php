...
<html>
<header>
	<title>ToDoIst - Sign up account as a Teacher</title>
...
<div id="content_part">
	<div id="signup_content">
		...
		<div style="height:20px; width:382px; padding-top:16px;">Teacher ID No</div>
		<div  style="width:800px; height:36px;">
		...
		<div style="width:382px; height:36px; float:left; border-radius:10px">
			<div style="float:left;"><input type="submit" id="signup_btn" value="Sign Up" tabindex="18" height="100%"/></div>
		...
		<input type="hidden" name="category" value="Teacher" required />
	</div>
</div>
</form>
