...
<head>
	...
	<title>ToDoIst - View Teacher Information</title>
	<style>
		#content td
		{
			padding:10px 0px;
	...
	<style type="text/css">
		...
		#department,#result_btn,#view_info,#delete_btn
		{
			margin-left:5%;
			font-size:17px;
				...
				<div id="right_middle_content" >
					<?php
						...
						if(!empty($_GET["department"]))
						{
							...
							if($department != "all")
							{
								$query_login = "select * from login_table l,teacher_info t where l.category ='Teacher' and l.college_id = t.college_id and t.department='$department' order by l.college_id";
							}
							else
							{
								$query_login = "select * from login_table l,teacher_info t where l.category ='Teacher' and l.college_id = t.college_id order by l.college_id";
							}
						}
						else
						{
					...
					<div id="content" align="left" style="font-size:20px;">	
						<div style="margin-top:-20px;"> 
							<form method="get" action="teacher_information.php" name="information_option">
						...
						<form method="get" action="teacher_information_process.php" name="information_content" enctype=""multipart/form-data">
