<?php
	...
	if(!ctype_alpha(fname))
	{
		...
		header("Location: ../hod/edit_profile.php.php");
	}
	if(!ctype_alpha(lname))
	{
		$_SESSION['alert']="The fill last name does not consist of all letters";
		header("Location: ../../hod/edit_profile.php");
	}
	...
	$query_no="select no from hod_info where college_id='$userid'";
	...
	if(isset($filename))
	{
		...
		header("Location: ../../hod/edit_profile.php");
		$query_info = "update hod_info set college_id='$college_id',department='$department',address='$address',designation='$designation',qualification=$qualification,skills='$skills',profile_pic='$renamefilename' ,actual_pic='$filename' where no='$userid'";
		
	}
	else
	{
		$query_info = "update hod_info set college_id='$college_id',department='$department',address='$address',designation='$designation',qualification='$qualification',skills='$skills'  where no='$userid'";
	}
