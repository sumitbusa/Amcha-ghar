<?php
	...
	if(!ctype_alpha(fname))
	{
		...
		header("Location: ../student/edit_profile.php.php");
	}
	...
	$query_no="select no from student_info where college_id='$userid'";
	...
	if(isset($filename))
	{
		...
		header("Location: ../../student/edit_profile.php");
		$query_info = "update student_info set college_id='$college_id',sap_no='$sap_no',address='$address',course='$course',semester='$semester',profile_pic='$renamefilename' ,actual_pic='$filename' where no='$userid'";
		
	}
	else
	{
		$query_info = "update student_info set college_id='$college_id',sap_no='$sap_no',address='$address',course='$course',semester='$semester'  where no='$userid'";
	}
