				...
				<div id="right_middle_content" >
					<?php
						...
						if(!empty($_GET["department"]))
						{
							...
							if($department != "all")
							{
								$query_login = "select * from login_table l,hod_info h where l.category ='HOD' and l.college_id = h.college_id and h.department='$department' order by l.college_id";
							}
							else
							{
								$query_login = "select * from login_table l,hod_info h where l.category ='HOD' and l.college_id = h.college_id order by l.college_id";
							}
						}
						else
						{
					...
					<div id="content" align="left" style="font-size:20px;">	
						<div style="margin-top:-20px;"> 
							<form method="get" action="hod_information.php" name="information_option">
						...
						<form method="get" action="hod_information_process.php" name="information_content" enctype=""multipart/form-data">
