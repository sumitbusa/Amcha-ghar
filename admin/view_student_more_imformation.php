			...
			<div id="right_contents">
				<div id="right_middle_content" >
					<?php
						...
						$query_info = "select * from student_info where email_id = '$user_email_id'";
					...
					<form method="post" name="updating_form" action="process/updateprofile_process.php" enctype="multipart/form-data">
						<div id="content" align="left" style="font-size:20px;">
							<table border="0">
								<tr >
									<td><lable class="view_profile_lable">Profile pic</lable></td>
									<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
									<td>
									<?php
										...
										{
									?>
											<img src="../images/Profile Pic/<?php echo $query_info_run_result['profile_pic']; ?>" height:"50px" width:"50px"</td>
									<?php
										}
										else
										{
